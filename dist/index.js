...
const directory_tree_1 = __importDefault(__nccwpck_require__(605));
/**
...
function getDirectoryTree(rootPath) {
    return directory_tree_1.default(rootPath);
}
...
const definition_mapper_1 = __nccwpck_require__(918);
const directory_tree_1 = __nccwpck_require__(79);
const mkdocs_definition_1 = __nccwpck_require__(610);
function run() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.substringWorkingDirectory = exports.getMkDocs = void 0;
...
function getNavItems(directoryTree, navItem, workingDirectory) {
    ...
    if (directoryTree.children && hasChildDirectories(directoryTree)) {
        const children = directoryTree.children
            ...
            .map(child => getNavItems(child, {}, workingDirectory));
        const flatten = [].concat(...children);
        navItem.children = flatten;
        navItem.name = utils_1.replaceUnderscoresWithSpaces(directoryTree.name);
...
exports.substringWorkingDirectory = substringWorkingDirectory;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.replaceUnderscoresWithSpaces = void 0;
/**
